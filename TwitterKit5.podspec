Pod::Spec.new do |s|
  ...
  s.homepage = "https://github.com/Adolade/twitter-kit-ios"
  s.documentation_url = "https://github.com/Adolade/twitter-kit-ios/wiki"
  s.social_media_url = ""
  s.authors = "Adolade"
  s.platform = :ios, "9.0"
  s.source = "https://github.com/Adolade/twitter-kit-ios/blob/master/TwitterKit.zip"
